 ...
 */
#define I2C_SLAVE_ADDRESS 0x04 // the 7-bit address (remember to change this when adapting this example)
...
void loop()
{
    ...
    if (write_flag) {
      write_flag = false;
      digitalWrite(red, i2c_regs[0] == 0);
      digitalWrite(blu, i2c_regs[1] == 0);
      digitalWrite(grn, i2c_regs[2] == 0);
    }
}
